...
variable "vibe_code" {
  type        = string
  description = "Paste your HTML code for the live-editable SPA. Default contains a sample app."
  default     = <<EOT
<!DOCTYPE html>
<html>
  <head>
...
variable "resource_group_name" {
  type        = string
  description = "The IBM Cloud resource group to deploy resources into."
  default     = "Default"
}

variable "bucket_name_prefix" {
  type        = string
  description = "The prefix for the COS bucket name."
...
variable "location" {
  type        = string
  description = "IBM Cloud region for the COS bucket (e.g., us-south)."
  default     = "us-south"
}
