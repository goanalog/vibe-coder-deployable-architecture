...
###############################################################################
# Notes for Schematics and Catalog UI
###############################################################################
# - All variables are visible and typed for Catalog onboarding.
# - Smart defaults let a user click “Create” without changing anything.
# - Terraform type system ensures predictable validation.
###############################################################################
